...
protected $FooterShow;         // FooterShow
...
function SetFooterShow($active)
{
  $this->InFooter = $active;
}

function SetHeaderShow($active)
{
  $this->InHeader = $active;
}
...
function Header()
{
  ...
  $this->Cell(71,10, date('d/m/Y') ,0,0,'L');
  $this->Ln(10);
}
...
function Footer()
{
  ...
  $y = $this->GetY();
  $this->Image(BASE_URL."assets/images/footer.jpg", 0, $y, 300, 10); 
  // Page number
  //$this->Cell(10,10,'',0,0,'L');
  //$this->Cell(71,10, strtoupper("It's Me For Breeding") ,0,0,'L');
}
